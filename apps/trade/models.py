...
from django.contrib.auth import get_user_model  # 重新家宅UserProfile
...
class ShoppingCart(models.Model):
    ...
    nums = models.IntegerField(default=0,verbose_name=u'商品数量')
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')

    class Meta:
        verbose_name = u'购物车'
        verbose_name_plural = verbose_name
        unique_together = ('user','goods')  # 联合唯一查询避免相关问题报错
