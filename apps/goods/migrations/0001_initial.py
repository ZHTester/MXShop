# Generated by Django 2.0 on 2019-12-25 01:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('good_sn', models.CharField(default='', max_length=200, verbose_name='商品唯一货号')),
                ...
                ('market_price', models.FloatField(default=0, max_length=50, verbose_name='市场价格')),
                ('shop_price', models.FloatField(default=0, max_length=50, verbose_name='本店价格')),
                ('goods_brief', models.TextField(max_length=1000, verbose_name='商品简单描述')),
                ...
                ('is_hot', models.BooleanField(default=False, verbose_name='是否是热卖')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', help_text='类别名', max_length=300, verbose_name='类别名')),
                ('code', models.CharField(default='', help_text='类别code', max_length=200, verbose_name='类别code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=200, verbose_name='品牌名称')),
